...
| 2026-09-04 | [0034](0034-layered-graph-drawing-in-the-design-editor.md) | Accepted | Defines the additive layered arrangements of the design editor: ELK layered placement and routing consumed together, label-aware spacing, back edges routed outside the band, and the existing arrangements left unchanged. |
