...
| 2026-09-14 | [0041](0041-governed-workspace-agent-runner-plane.md) | Proposed implementation contract | Defines tenant-governed workspace agents, the versioned runner protocol, fenced unknown-effect recovery, and process-scoped sandbox ownership. |
