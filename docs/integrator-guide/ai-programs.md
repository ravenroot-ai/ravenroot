...
3. For agents, grant both `outbound-http` and `tool-authorization`, intersect discovered tools with
   the operator allowlist, and keep tool results inside payload budgets.
