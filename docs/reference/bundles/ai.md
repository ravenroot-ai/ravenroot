...
See the [published variant](../node-contracts.md#governed-workspace-and-named-agent-variant) and
[operator guide](../../operator-guide/governed-runners.md). Deterministic protocol fixtures are not
