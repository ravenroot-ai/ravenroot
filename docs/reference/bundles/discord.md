...
> [`ravenroot-discord` module README](https://github.com/ravenroot-ai/ravenroot/blob/dev/ravenroot/ravenroot-extensions/ravenroot-discord/README.md) in this documentation revision, whose
> product contract was audited at the documented development baseline. The optional package identity
> is `ai.ravenroot.extensions.discord` and it contributes `discord.interactions`, `discord.send`.
