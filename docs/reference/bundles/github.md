...
> [`ravenroot-github` module README](https://github.com/ravenroot-ai/ravenroot/blob/dev/ravenroot/ravenroot-extensions/ravenroot-github/README.md) in this documentation revision, whose
> product contract was audited at the documented development baseline. The optional package identity
> is `ai.ravenroot.extensions.github` and it contributes `github-events-source`, `project-transition`, `github-app-review`, `github-workflow-watch`, `release-prepare`.
