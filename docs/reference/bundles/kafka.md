...
> [`ravenroot-kafka` module README](https://github.com/ravenroot-ai/ravenroot/blob/dev/ravenroot/ravenroot-extensions/ravenroot-kafka/README.md) in this documentation revision, whose
> product contract was audited at the documented development baseline. The optional package identity
> is `ai.ravenroot.extensions.kafka` and it contributes `kafka.produce`, `kafka.consume`.
