...
> [`ravenroot-openapi-client` module README](https://github.com/ravenroot-ai/ravenroot/blob/dev/ravenroot/ravenroot-extensions/ravenroot-openapi-client/README.md) in this documentation revision, whose
> product contract was audited at the documented development baseline. The optional package identity
> is `ai.ravenroot.extensions.openapi.client` and it contributes `openapi.call`.
