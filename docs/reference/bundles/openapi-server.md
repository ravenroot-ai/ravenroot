...
> [`ravenroot-openapi-server` module README](https://github.com/ravenroot-ai/ravenroot/blob/dev/ravenroot/ravenroot-extensions/ravenroot-openapi-server/README.md) in this documentation revision, whose
> product contract was audited at the documented development baseline. The optional package identity
> is `ai.ravenroot.extensions.openapi.server` and it contributes `openapi.receive`, `openapi.request-reply`.
