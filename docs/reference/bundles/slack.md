...
> [`ravenroot-slack` module README](https://github.com/ravenroot-ai/ravenroot/blob/dev/ravenroot/ravenroot-extensions/ravenroot-slack/README.md) in this documentation revision, whose
> product contract was audited at the documented development baseline. The optional package identity
> is `ai.ravenroot.extensions.slack` and it contributes `slack.events`, `slack.commands`, `slack.post-message`.
