...
> [`ravenroot-telegram` module README](https://github.com/ravenroot-ai/ravenroot/blob/dev/ravenroot/ravenroot-extensions/ravenroot-telegram/README.md) in this documentation revision, whose
> product contract was audited at the documented development baseline. The optional package identity
> is `ai.ravenroot.extensions.telegram` and it contributes `telegram.send`, `telegram.answer.callback`, `telegram.edit.message`, `telegram.delete.message`.
