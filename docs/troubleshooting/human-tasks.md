...
| Registered presentation is unavailable | Check `registeredPresentationsEnabled`, registry readability, profile id/version/kind, safe launch origin, and that a custom origin differs from Workbench. | Repair the operator registry and restart; the task remains open. |
