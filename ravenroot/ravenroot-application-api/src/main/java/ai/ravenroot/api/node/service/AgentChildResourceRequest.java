 ...
 *
 * @param child trusted child invocation identity
 * @param dataScopes requested attenuated data scopes
 * @param authorityScopes requested attenuated authority scopes
 * @param resources requested finite child resources
 */
public record AgentChildResourceRequest(NodeMessage child, Set<String> dataScopes,
    ...
    /** Validates and snapshots the child authority request. */
