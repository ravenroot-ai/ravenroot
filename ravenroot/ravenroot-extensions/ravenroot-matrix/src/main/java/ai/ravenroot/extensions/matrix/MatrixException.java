...
/** Closed, content-free Matrix extension failure. */
public final class MatrixException extends RuntimeException
    ...
    public enum Code {
        ...
        INVALID_INPUT,
        /** Managed credentials are unavailable or Matrix rejected them. */
        ...
        RATE_LIMITED,
        /** Matrix deterministically rejected the operation. */
        REMOTE_REJECTED,
    ...
    MatrixException(Code code) {
        super("Matrix operation failed: " + java.util.Objects.requireNonNull(code).name());
        this.code = code;
    }
