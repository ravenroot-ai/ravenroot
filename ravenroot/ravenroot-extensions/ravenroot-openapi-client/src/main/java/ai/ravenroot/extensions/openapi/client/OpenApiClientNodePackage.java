...
public final class OpenApiClientNodePackage implements NodePackage {
    ...
    @Override public List<NodeBehavior> behaviors() { return List.of(new OpenApiCallNodeBehavior()); }
}
