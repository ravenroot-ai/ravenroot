...
public final class OpenApiSpecGenerator {
    ...
    private static String successResponse(RouteDescriptor route, String method, int status) {
        if ("/v1/events".equals(route.path()) && "GET".equals(method) && status == 200) {
            return "          \"200\": {\"description\":\"UTF-8 Server-Sent Events text, not a JSON document or JSON array. Parse blank"
                     ...
                     + "d\\\":\\\"20000000-0000-0000-0000-000000000002\\\",\\\"deploymentId\\\":null,\\\"type\\\":\\\"EXECUTION_STARTED\\\",\\\"activeInstances\\\":0,\\\"inFlightAr"
    ...
    private static String deploymentSchemas() {
        return "      \"LifecycleCommandCapability\": {\"type\":\"object\",\"required\":[\"command\",\"available\",\"reasonRequired\",\"unavailableReason\"],\"properties\":{\"command\":{\"type\":\"string\",\"enum\":[\"START\",\"PAUSE\",\"RESUME\",\"CANCEL\",\"DRAIN\",\"STOP\",\"RESTART\",\"UNDEPLOY\"]},\"available\":{\"type\":\"boolean\"},\"reasonRequired\":{\"type\":\"boolean\"},\"unavailableReason\":{\"type\":\"string\",\"nullable\":true}}},\n"
                ...
                + "      \"LocalDeploymentStatus\": {\"type\":\"object\",\"required\":[\"deploymentId\",\"state\",\"sourceCount\",\"graphVersion\",\"scope\",\"diagnostic\",\"lifecycleCapabilities\"],\"properties\":{"
                ...
                + "\"diagnostic\":{\"type\":\"string\",\"maxLength\":192,\"nullable\":true},\"deploymentGeneration\":{\"type\":\"integer\",\"format\":\"int64\",\"minimum\":0,\"description\":\"Present only when this deployment is governed by durable lifecycle authority.\"},\"lifecycleCapabilities\":{\"$ref\":\"#/components/schemas/LifecycleCapabilities\"}}},\n"
    ...
    private static String executionEventSchemas() {
        return "      \"ExecutionStreamEventBase\": {\"type\":\"object\",\"description\":\"Version 1 JSON data of an execution SSE fram"
                 ...
                 + "format\":\"uuid\"},\"deploymentId\":{\"type\":\"string\",\"description\":\"Owning long-lived deployment; null for a one-shot submission that opened no deployment domain. The only identity a client can hold before a source-produced traversal exists. Emitted on RING frames; the durable journal does not retain it, so a DURABLE frame omits it rather than reporting null.\",\"nullable\":true},\"graphVersion\":{\"type\":\"string\"},\"description\":{\"type\":\"string\"},\"invocationId\":{\"type\":\"strin"
                 ...
                 + "eId\":\"pekko\",\"executionId\":\"20000000-0000-0000-0000-000000000002\",\"deploymentId\":null,\"type\":\"EXECUTION_STARTED\",\"activeInstances\""
