...
public final class RouteTable {
    ...
    public static final List<RouteDescriptor> ALL = List.of(
            ...
            new RouteDescriptor(Set.of("GET"), "/v1/runner-plane/audit",
                    ...
                    true, false, 200, STANDARD_ERRORS, NEVER, true),
            new RouteDescriptor(Set.of("GET", "PUT", "POST"), "/v1/runner-plane",
                    "Opt-in governed runner protocol v1. Disabled deployments return 501. Tenant identity is authenticated, never a request field.",
            ...
            new RouteDescriptor(Set.of("POST"), "/v1/runner-plane/workspaces/{processId}/jobs/{jobId}/artifacts",
                    "Bounded streaming upload under a live X-Runner-Fence and X-Artifact-Kind. Returns durable digest metadata, never a host path.",
                    true, false, 201, STANDARD_ERRORS, NEVER, false),
            new RouteDescriptor(Set.of("POST"), "/v1/runner-plane/workspaces/{processId}/jobs/{jobId}/{operation}",
                    "claim, heartbeat and reconcile-report accept ttlSeconds (maximum 300); heartbeat also requires fence. complete accepts a binary v1 RunnerResult and X-Runner-Fence. cancel/reconcile require an operator. Stale fences and conflicts return 409; unknown work is never retried.",
                    true, false, 200, STANDARD_ERRORS, NEVER, false),
