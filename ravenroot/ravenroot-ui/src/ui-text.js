const ENGLISH_MESSAGES = Object.freeze({
  ...
  'commands.layout.arrange.flow-new.label': 'Arrange — Flow (new)',
  'commands.layout.arrange.flow-new.help': 'Arrange on compact layers with curved, label-aware edge channels',
